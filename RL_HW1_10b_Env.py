...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open("RL_HW1_img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("RL_HW1_img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("RL_HW1_img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("RL_HW1_img/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("RL_HW1_img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("RL_HW1_img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("RL_HW1_img/circle.png").resize((65, 65)))
...
class Env:
    def __init__(self):
        ...
        self.reward[2][3] = -1  # reward -1 for triangle
        self.all_state = []
